...
const AddNote = (props) => {
    ...
    return (
        <div className="container text-dark add-note-container">
            <h2>Add a Note</h2>
            <form className="my-3">
                <div className="mb-3">
                    <label htmlFor="title" className="form-label font-weight" >Title</label>
                    <input type="text" className="dark-wide-border form-control text-dark" style={{backgroundColor:'#0000'}} id="title" name="title" aria-describedby="emailHelp" 
                           value={note.title}  onChange={onChange}
                           minLength={5} required/> 
                </div>
                <div className="mb-3">
                    <label htmlFor="description" className="form-label font-weight">Description</label>
                    <textarea className="dark-wide-border form-control text-dark" rows="5"
                ...
                <div className="mb-3">
                    ...
                    <input type="text" className="dark-wide-border form-control text-dark" 
                           style={{backgroundColor:'#0000'}} id="tag" name="tag" value={note.tag} 
                           onChange={onChange}/>
                    <span class="custom-placeholder"><i>(Optional)</i></span>
                </div>
